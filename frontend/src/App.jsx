  ...
  useEffect(() => {
    async function checkApi() {
      try {
        ...
        setApiStatus(data.success ? "Connected" : "Unavailable");
      } catch (error) {
      ...
      <main className="main-content">
        ...
        {activePage === "Dashboard" ? (
          <>
            <section className="welcome-section">
              <div>
                ...
                <h3>Welcome to JobPilot</h3>

                <p>
                  Organize your job search, tailor your resume,
                  and manage your application progress.
                </p>
              </div>
            ...
            <section className="content-card">
              <div className="section-heading">
                <div>
                  <h3>Recent Jobs</h3>
                  <p>Example data for the initial dashboard.</p>
                </div>
          ...
          <section className="content-card page-placeholder">
            ...
            <p>
              This module is planned for a later development phase.
